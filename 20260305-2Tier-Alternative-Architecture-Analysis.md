...
| **SharePoint Lists per team** | Private channel SharePoint sites support document libraries only — List 3 (Weekly Task Reports) cannot be built |
| **Flow 3 weekly report routing** | With no team-specific SharePoint Lists, Flow 3 has no destination to write responses to |
...
|---|---|---|
| Create the Tier 1 Communication Site | Ops | No |
| Create the standalone Operations Team Site | Ops | No |
